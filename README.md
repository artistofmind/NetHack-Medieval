...
1. [Introduction](https://github.com/artistofmind/NetHack-Medieval/tree/main?tab=readme-ov-file#1-introduction)
...
Game-icons.net also has some pictures I really wanted to use, but couldn’t. For instance, they have an icon specifically for holy water! It would be so cool if a future version of _NetHack_ has three different “clear potion” tiles, defaults to the uncursed one and only changes when it’s identified as either blessed or cursed. If & when that day comes, I will update this set accordingly. 🙂
...
Be assured I will keep this tileset up to date for as long as I’m alive & able. So when a new version of _NetHack_ adds more tiles, so will I. 🙂
